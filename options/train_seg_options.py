...
class TrainOptions():
    def initialize(self):
        parser = argparse.ArgumentParser(description="random plus location plus predictability netowork.")
        ...
        parser.add_argument("--seg-classes", type=int, default=9, help="number of seg parts.")
        parser.add_argument("--add-crop", type=ast.literal_eval, default=True, help="whether add FGcrop images.")
        parser.add_argument("--add-pre", type=ast.literal_eval, default=True, help="whether add predictability in predictions.")
        ...
        parser.add_argument("--lam", type=float, default=0.001, help="lambda for seg_loss.")
        ...
        parser.add_argument("--train-gt-dir", type=str, default='gt_dict/preset_car_{}_gt.npy', help="Path to the directory containing the train gt.")
        ...
        parser.add_argument("--crop-gt-dir", type=str, default='gt_dict/preset_car_crop_{}_gt.npy', help="Path to the directory containing the FGcrop images.")
        ...
        parser.add_argument("--test-gt-dir", type=str, default='gt_dict/preset_all_random_{}_gt.npy', help="Path to the directory containing the test images.")
        ...
        parser.add_argument("--train-seg-gt-dir", type=str, default='segsets/train/preset_car_seg/', help="Path to the directory saving the train seg gt.")
        parser.add_argument("--test-seg-gt-dir", type=str, default='segsets/train/preset_car_seg/', help="Path to the directory saving the test seg gt.")
        ...
        parser.add_argument("--texture", type=ast.literal_eval, default=False, help="Whether data has name problem.")
